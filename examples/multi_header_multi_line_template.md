...
- `line_items` sheet = one row per line item
- `ref_id` = common key used to attach lines to the correct header
...
| ref_id | startUrl | username | password | customer_name | customer_number | transaction_date | accounting_date |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| ref_id | line_description | quantity | unit_price |
| --- | --- | --- | --- |
